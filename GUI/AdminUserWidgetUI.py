...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.refreshPushButton = QtWidgets.QPushButton(self.userSelectionWidget)
        self.refreshPushButton.setFocusPolicy(QtCore.Qt.NoFocus)
        self.refreshPushButton.setObjectName("refreshPushButton")
        self.gridLayout_3.addWidget(self.refreshPushButton, 7, 0, 1, 1)
